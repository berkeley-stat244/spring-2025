...
Try asking a ChatBot to write a norm function in Julia. When I tried Claude it gave me a better answer than what I wrote above (handling more cases for values of $p$ and with a docstring.
...
A struct is a "composite type", a collection of named fields, useful for holding information of a particular structure. 

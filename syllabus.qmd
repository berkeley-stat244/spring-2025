...
- Anonymous private posts:
   - If you'd like to leave anonymous feedback via a private post to me, you can, but I encourage you not to make it anonymous. But I won't answer general topic/course questions that are posted anonymously, whether public or private.
...
Most work for the course can be done on your laptop. Later in the course (in a couple weeks!), we'll also use the Statistics Department Linux cluster for access to GPUs. Please [sign up for an SCF account](https://statistics.berkeley.edu/computing/getting-started/computing-accounts) now if you don't have one.
...
Tentatively, I'm anticipating the following requirement for projects/presentations -- with each student selecting one of:
  ...
  - two presentations
  - a single presentation on a meaty topic

I'll need to think about how that is adjusted if done in pairs. It may simply be an expectation of more in-depth work if a project or presentation is shared.
